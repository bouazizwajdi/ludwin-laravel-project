...
@section("descmodule",__('messages.Edit BI reports'))
@section("btnright")
    <a href="{{route('reports.index')}}" class="btn btn-sm fw-bold btn-dark">
        {{__('messages.List Reports')}}
    </a>
@endsection
@section("content")
...
<div class="card mb-5 mb-xl-10">
    <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed  p-6 m-6">
        ...
        <div class="d-flex flex-stack flex-grow-1 ">
            <div class=" fw-semibold">
                <div class="fs-6 text-gray-700 ">{{__('messages.This form allows you to quickly modify a report.')}} </div>
            </div>
        </div>
    </div>
 ...
 <form action="{{route("reports.update",$report->id)}}" method="POST" class="form" enctype="multipart/form-data">
    @method("PUT")
    @csrf
    ...
    <div class="card-body border-top p-9">
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8 fv-row">
                <input class="form-control form-control-lg  @error('name') is-invalid @enderror"  value="{{$report->name}}" type="text" name="name" id="name" required>
        @error('name')
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8 fv-row">
                ...
                <img src="{{asset('files/reports/'.$report->logo)}}">
                @endif
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8 fv-row">
                ...
                <textarea class="form-control  @error('integration_code') is-invalid @enderror" id="integration_code" name="integration_code" rows="3" >{{$report->integration_code}}</textarea>
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8 fv-row">
                <div id="kt_ecommerce_add_product_description" name="kt_ecommerce_add_product_description" class="h-200px mb-2"  id="description" name="description" rows="3">{{$report->description}}</div>
            </div>
        </div>
